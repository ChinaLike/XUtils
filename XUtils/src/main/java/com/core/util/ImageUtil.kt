...
import com.core.util.FileUtil.closeIO
import com.core.util.FileUtil.createOrExistsFile
import com.core.util.FileUtil.getFileByPath
import java.io.*
...
object ImageUtil {
    ...
    fun getBitmap(resId: Int): Bitmap? {
        val `is` = XUtil.getApp().resources.openRawResource(resId)
    ...
    fun getBitmapFromNet(imgUrl: String?): Bitmap? {
        ...
        try {
            ...
            if (httpURLConnection.responseCode == 200) {
                ...
                Log.d("网络连接失败----" , "${httpURLConnection.responseCode}")
            }
        } catch (e: Exception) {
