...
object TimeUtil {
     ...
     */
    val DEFAULT_SDF = SimpleDateFormat(Constants.DATE_FORMAT_DETACH, Locale.getDefault())
    /**
     * 将时间戳转为时间字符串
     *
     * 格式为用户自定义
     ...
     */
    @JvmStatic
    fun milliseconds2Unit(milliseconds: Long, unit: ConstUtil.TimeUnit?): Long {
        when (unit) {
            ConstUtil.TimeUnit.MSEC -> return milliseconds / MSEC
            ConstUtil.TimeUnit.SEC -> return milliseconds / SEC
            ConstUtil.TimeUnit.MIN -> return milliseconds / MIN
            ConstUtil.TimeUnit.HOUR -> return milliseconds / HOUR
            ConstUtil.TimeUnit.DAY -> return milliseconds / DAY
            else -> {
            }
        }
        return -1
     ...
     */
    @JvmStatic
    fun getIntervalTime(time0: String?, time1: String?, unit: ConstUtil.TimeUnit?): Long {
     ...
     */
    @JvmStatic
    fun getIntervalTime(time0: String?, time1: String?, unit: ConstUtil.TimeUnit?, format: SimpleDateFormat): Long {
        return Math.abs(
            milliseconds2Unit(
     ...
     */
    @JvmStatic
    fun getIntervalTime(time1: Date, time2: Date, unit: ConstUtil.TimeUnit?): Long {
        return Math.abs(
            milliseconds2Unit(
     ...
     */
    @JvmStatic
    fun getIntervalByNow(time: String?, unit: ConstUtil.TimeUnit?): Long {
     ...
     */
    @JvmStatic
    fun getIntervalByNow(time: String?, unit: ConstUtil.TimeUnit?, format: SimpleDateFormat): Long {
     ...
     */
    @JvmStatic
    fun getIntervalByNow(time: Date, unit: ConstUtil.TimeUnit?): Long {
    ...
    fun formatTime(milliseconds: Long): String {
        val format = Constants.DATE_FORMAT_MM_SS
