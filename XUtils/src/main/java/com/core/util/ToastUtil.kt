...
object ToastUtil {
    ...
    fun normal(message: String) {
        normal(XUtil.getApp(), message, Toast.LENGTH_SHORT, null, false)?.show()
    }

    @JvmStatic
    fun normal(message: String, icon: Drawable?) {
        normal(XUtil.getApp(), message, Toast.LENGTH_SHORT, icon, true)?.show()
    }

    @JvmStatic
    fun normal(message: String, duration: Int) {
        normal(XUtil.getApp(), message, duration, null, false)?.show()
    }

    @JvmStatic
    fun normal(message: String, duration: Int, icon: Drawable?) {
        normal(XUtil.getApp(), message, duration, icon, true)?.show()
    }

    @JvmStatic
    fun normal(message: String, duration: Int, icon: Drawable?, withIcon: Boolean): Toast? {
        return custom(XUtil.getApp(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon)
    }

    @JvmStatic
    fun warning(message: String) {
        warning(XUtil.getApp(), message, Toast.LENGTH_SHORT, true)?.show()
    }

    @JvmStatic
    fun warning(message: String, duration: Int) {
        warning(XUtil.getApp(), message, duration, true)?.show()
    }
    ...
    fun warning(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            XUtil.getApp(),
            message,
            getDrawable(XUtil.getApp(), R.drawable.ic_error_outline_white_48dp),
            DEFAULT_TEXT_COLOR,
            WARNING_COLOR,
            duration,
            withIcon,
    ...
    fun info(message: String) {
        info(XUtil.getApp(), message, Toast.LENGTH_SHORT, true)?.show()
    }

    @JvmStatic
    fun info(message: String, duration: Int) {
        info(XUtil.getApp(), message, duration, true)?.show()
    }
    ...
    fun info(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            XUtil.getApp(),
            message,
            getDrawable(XUtil.getApp(), R.drawable.ic_info_outline_white_48dp),
            DEFAULT_TEXT_COLOR,
            INFO_COLOR,
            duration,
            withIcon,
    ...
    fun success(message: String) {
        success(XUtil.getApp(), message, Toast.LENGTH_SHORT, true)?.show()
    }

    @JvmStatic
    fun success(message: String, duration: Int) {
        success(XUtil.getApp(), message, duration, true)?.show()
    }
    ...
    fun success(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            XUtil.getApp(),
            message,
            getDrawable(XUtil.getApp(), R.drawable.ic_check_white_48dp),
            DEFAULT_TEXT_COLOR,
            SUCCESS_COLOR,
            duration,
            withIcon,
    ...
    fun error(message: String) {
        error(XUtil.getApp(), message, Toast.LENGTH_SHORT, true)?.show()
    }
    ...
    fun error(message: String, duration: Int) {
        error(XUtil.getApp(), message, duration, true)?.show()
    }
    ...
    fun error(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            XUtil.getApp(),
            message,
            getDrawable(XUtil.getApp(), R.drawable.ic_clear_white_48dp),
            DEFAULT_TEXT_COLOR,
            ERROR_COLOR,
            duration,
            withIcon,
    ...
    fun showToastShort(str: String?) {
        Toast.makeText(XUtil.getApp(), str, Toast.LENGTH_SHORT).show()
    }
    ...
    fun showToastShort(resId: Int) {
        Toast.makeText(XUtil.getApp(), XUtil.getApp().getString(resId), Toast.LENGTH_SHORT).show()
    }
    ...
    fun showToastLong(str: String?) {
        Toast.makeText(XUtil.getApp(), str, Toast.LENGTH_LONG).show()
    }
    ...
    fun showToastLong(resId: Int) {
        Toast.makeText(XUtil.getApp(), XUtil.getApp().getString(resId), Toast.LENGTH_LONG).show()
    }
    ...
    fun showToast(msg: String?) {
        if (mToast == null) {
            mToast = Toast.makeText(XUtil.getApp(), msg, Toast.LENGTH_LONG)
        } else {
            mToast?.setText(msg)
        }
        mToast?.show()
    ...
    fun showToast(resId: Int) {
        if (mToast == null) {
            mToast = Toast.makeText(XUtil.getApp(), XUtil.getApp().getString(resId), Toast.LENGTH_LONG)
        } else {
            mToast?.setText(XUtil.getApp().getString(resId))
        }
        mToast?.show()
    }
