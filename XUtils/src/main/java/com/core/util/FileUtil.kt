...
import com.core.util.ConstUtil.KB
import com.core.util.DataUtil.byte2FitSize
import com.core.util.DataUtil.inputStream2Bytes
import com.core.util.EncryptUtil.encryptMD5File2String
import java.io.*
...
//                    RxLogTool.d("ts替换", line + "  replce  " + pathList.get(num).getAbsolutePath());
    ...
    fun getFilePhotoFromUri(context: Activity?, uri: Uri?): File {
        return File(PhotoUtil.getImageAbsolutePath(context, uri))
    }
